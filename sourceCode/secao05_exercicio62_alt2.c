...
int main()
{
     ...
     int centena=0;
     int milhar=0;
     int numero=0; //Alterar aqui, para DEBUG. DEPOIS VOLTAR PARA ZERO e habilitar o scanf
     // Variáveis para armazenar o texto
     char sequencia[200];

     // Variáveis da parte contagem de caracteres
     //char str[str_size];
     int letras, digit, splch, i;
     letras = digit = splch = i = 0;     
    ...
    printf("Quantidade de letras na sequencia de caracteres é: %d\n", letras);
