 ...
 while (op != 7){
  system("cls");
   ...
   for (int i=0; i<n; ++i){
      ...
      printf("\n\t");
      if (A[i] == 0)  printf("   "); else printf("<%d>", A[i]);
      if (B[i] == 0)  printf("     "); else printf("  <%d>", B[i]);
      if (C[i] == 0)  printf("     "); else printf("  <%d>",C[i]);
   }
     printf("\n\t=============\n");
     printf("\t A    B    C \n");
     printf("\t=============\n\n");
   ...
   if (cont_B == n || cont_C == n) { printf("Parabens, voce conseguiu em %d movimentos!\n",n_mov); break;}
   ...
   if (op == 3){
     ...
     posi_2=0;
       ...
       for (int i=0; i<n; ++i){
         if (B[i]!=0){num = B[i]; B[i]=0; posi=i; break;}}
      
       for (int i=(n-1); i>=0; --i){
           if (A[i] == 0) {posi_2=i; break;}
       }
   ...
   if (op == 5){
     ...
     posi_2=0;
       ...
       for (int i=0; i<n; ++i){
         if (C[i]!=0){num = C[i]; C[i]=0; posi=i; break;}}
